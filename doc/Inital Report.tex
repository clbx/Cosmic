...
\begin{itemize}
	...
	\item \textbf{Cosmic Software \& Assembler}  - This portion is software written that is not directly part of cosmic. This includes an Assembler for the Cosmic Instruction set and software written that is targeted to run on a Cosmic system.
\end{itemize}
